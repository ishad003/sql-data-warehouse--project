...
Script and Purpose:
	This procedure loads data into the 'bronze' layer tables 
	from source CSV files using BULK INSERT.

WARNING:
	Make sure file paths are correct and accessible to SQL Server.
	Running this will truncate existing data in the bronze tables.
*/
